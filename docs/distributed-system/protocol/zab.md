...
![ZXID 结构](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/zab-zxid-structure.png)
...
![ZAB 消息广播模式](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/zab-message-broadcast-flow.png)
...
![zab-crash-recovery-flow](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/zab-crash-recovery-flow.png)
