...
![Gossip 翻译](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/gossip.png)
...
![Redis 的官方集群解决方案](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/up-fcacc1eefca6e51354a5f1fc9f2919f51ec.png)
...
![Redis Cluster  各个节点之间使用 Gossip 进行通信](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/redis-cluster-gossip.png)
...
![反熵机制：Push-Pull 交互时序图 (Anti-Entropy)](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/gossip-anti-entropy-pushpull.png)

伪代码如下：

![反熵伪代码](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/up-df16e98bf71e872a7e1f01ca31cee93d77b.png)
...
![确定性闭环调度](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/raft-anti-entropyclosed-loop.png)
...
![Gossip 传播示意图](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/gossip-rumor-mongering.gif)

伪代码如下：

![](/assets/images/oss.javaguide.cn/github/javaguide/csdn/20210605170707933.png)
...
![Gossip 协议：随机传播与收敛过程](/assets/images/oss.javaguide.cn/github/javaguide/distributed-system/protocol/gossip-propagation.png)
