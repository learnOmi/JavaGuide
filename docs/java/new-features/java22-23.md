...
![](/assets/images/oss.javaguide.cn/github/javaguide/java/new-features/jdk22-new-features.png)
...
![Markdown 文档注释](/assets/images/oss.javaguide.cn/github/javaguide/java/new-features/jep467-markdown-documentation-comments.png)
