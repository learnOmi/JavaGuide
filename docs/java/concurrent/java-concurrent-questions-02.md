...
![JMM(Java 内存模型)强制在主存中进行读取](/assets/images/oss.javaguide.cn/github/javaguide/java/concurrent/jmm2.png)
...
![JUC原子类概览](/assets/images/oss.javaguide.cn/github/javaguide/java/JUC原子类概览-20230814005211968.png)
...
![JUC原子类概览](/assets/images/oss.javaguide.cn/github/javaguide/java/JUC原子类概览.png)
...
![synchronized关键字原理](/assets/images/oss.javaguide.cn/github/javaguide/java/concurrent/synchronized-principle.png)
...
![执行 monitorenter 获取锁](/assets/images/oss.javaguide.cn/github/javaguide/java/concurrent/synchronized-get-lock-code-block.png)

对象锁的拥有者线程才可以执行 `monitorexit` 指令来释放锁。在执行 `monitorexit` 指令后，将锁计数器设为 0，表明锁被释放，其他线程可以尝试获取锁。

![执行 monitorexit 释放锁](/assets/images/oss.javaguide.cn/github/javaguide/java/concurrent/synchronized-release-lock-block.png)
...
![synchronized关键字原理](/assets/images/oss.javaguide.cn/github/javaguide/synchronized关键字原理2.png)
...
![](/assets/images/oss.javaguide.cn/github/javaguide/java/concurrent/reentrantlock-class-diagram.png)
...
![](/assets/images/oss.javaguide.cn/github/javaguide/java/concurrent/reentrantreadwritelock-class-diagram.png)
