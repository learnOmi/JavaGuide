...
![](/assets/images/oss.javaguide.cn/xingqiu/java-interview-guide-statistics.png)
...
![《Java 面试指北》 收到的部分球友的真实反馈](/assets/images/oss.javaguide.cn/xingqiu/praise-that-the-mianshizhibei-received.png)
...
![](/assets/images/oss.javaguide.cn/javamianshizhibei/java-project-experience-and-interview-faq.png)

另外，考虑到很多同学项目经历不足，我还专门整理了一批**小众但优质的实战项目**：既有配套视频，也有高质量开源仓库，既包含完整业务系统，也有技术含量很高的轮子类项目，方便你快速补齐项目短板。

![《Java面试指北》-实战项目推荐](/assets/images/oss.javaguide.cn/javamianshizhibei/practical-project-recommendation.png)
...
![《Java 面试指北》面经篇](/assets/images/oss.javaguide.cn/javamianshizhibei/real-interview-experience.png)
...
![《Java 面试指北》技术面试题自测篇](/assets/images/oss.javaguide.cn/javamianshizhibei/self-test.png)

每道题我都会给出**提示与思路**，并用 ⭐ 标注重要程度：⭐ 越多，说明面试越爱问，就越值得多花一些时间准备。

![](/assets/images/oss.javaguide.cn/javamianshizhibei/self-test-key-points.png)
...
![《Java 面试指北》练级攻略篇](/assets/images/oss.javaguide.cn/javamianshizhibei/training-strategy-articles.png)
...
![《Java 面试指北》工作篇](/assets/images/oss.javaguide.cn/javamianshizhibei/gongzuopian.png)
