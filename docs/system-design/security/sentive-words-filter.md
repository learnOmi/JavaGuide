...
![浏览器 Trie 树效果展示](/assets/images/oss.javaguide.cn/github/javaguide/system-design/security/brower-trie.png)
...
![敏感词 Trie 树](/assets/images/oss.javaguide.cn/github/javaguide/system-design/security/sensitive-word-trie.png)
...
![AC 自动机构建与匹配流程](/assets/images/oss.javaguide.cn/github/javaguide/system-design/security/sensitive-word-ac-automaton-flow.png)
...
![Hutool 的 DFA 算法](/assets/images/oss.javaguide.cn/github/javaguide/system-design/security/hutool-dfa.png)
...
![](/assets/images/oss.javaguide.cn/github/javaguide/system-design/security/sensitive-word-filter-arch.png)
