...
![NAT 将内网私有地址转换为公网地址的过程](/assets/images/oss.javaguide.cn/github/javaguide/cs-basics/network/nat-demo.png)
...
![LAN-WAN 间通信提供地址转换](/assets/images/oss.javaguide.cn/github/javaguide/cs-basics/network/nat-demo2.png)
