...
![macOS：查看各 TCP 状态数量和 TIME-WAIT 主要集中在哪些远端](/assets/images/oss.javaguide.cn/github/javaguide/cs-basics/network/macos-check-tcp-state-count-and-time-wait-remote-distribution.png)
