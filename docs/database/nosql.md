...
![](/assets/images/oss.javaguide.cn/github/javaguide/database/mongodb/sql-nosql-tushi.png)
...
![NoSQL 数据模型](/assets/images/oss.javaguide.cn/github/javaguide/database/mongodb/types-of-nosql-datastores.png)
