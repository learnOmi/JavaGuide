...
![Spring AI Alibaba 架构](/assets/images/oss.javaguide.cn/github/javaguide/open-source-project/ai/springai-alibaba-architecture-new.png)
...
![](/assets/images/oss.javaguide.cn/github/javaguide/open-source-project/ai/paiagent-architecture-diagram.jpg)
